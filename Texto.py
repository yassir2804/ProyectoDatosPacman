...
class GrupoTexto(object):
    ...
    def cargar_imagen_fruta(self):
        ...
        self.imagen_fruta = pygame.transform.scale(self.imagen_fruta, (45, 45))  # Escalar la imagen a 30x30
    ...
    def actualizarPuntaje(self, puntaje):
        if SCORETXT in self.todos_los_textos:
            nuevo_puntaje = str(puntaje).zfill(8)
            self.todos_los_textos[SCORETXT].setTexto(nuevo_puntaje)
    ...
    def renderizar(self, pantalla):
        ...
        # Renderizar las cerezas comidas en la esquina inferior derecha
